...
$$
\begin{align}
\frac{\partial C}{\partial x_i} &= \frac{mfrac{\partial C}{\partial \hat{x_i}} - \sum_{j=1}^{m}frac{\partial C}{\partial \hat{x_j}} - \hat{x_i}\sum_{j=1}^{m}frac{\partial C}{\partial \hat{x_j}}\hat{x_j}}{m\sqrt{ \sigma_B^2 + \epsilon }}
\end{align}
$$
